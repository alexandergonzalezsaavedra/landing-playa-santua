...
const solenciarMar = () => {
    audio.classList.contains("silenciar")
        ? (audio.classList.remove("silenciar"), audio.play(), iconoSonido.classList.remove("fa-volume-xmark"), iconoSonido.classList.add("fa-volume-low"))
        : (audio.classList.add("silenciar"), audio.pause(), iconoSonido.classList.add("fa-volume-xmark"), iconoSonido.classList.remove("fa-volume-low"));
};
document.addEventListener("click", (e) => {
    ...
    window.addEventListener("scroll", () => {
        ...
        if (e < 450 || e <= 0) for (let e = 0; e < pathsEstructura.length; e++) pathsEstructura[e].classList.add("estructura"), pathsEstructura[e].classList.remove("ocultarEstructura");
        else for (let e = 0; e < pathsEstructura.length; e++) pathsEstructura[e].classList.remove("estructura"), pathsEstructura[e].classList.add("ocultarEstructura");
    }),
    AOS.init();
